...
function romanTime(time) {
    ...
    var resultTime;
    var listH = [parseInt(hours / 10, 10), parseInt(hours % 10 / 5,10),parseInt(hours % 10 % 5, 10)];
    var listM = [parseInt(minutes / 50, 10), parseInt(minutes % 50 / 10, 10), parseInt(minutes % 10 / 5,10),parseInt(minutes % 10 % 5, 10)];
